...
from my_internet_speed.backends.speed_test_net import SpeedTest


@pytest.fixture
def speed_test_net(mocker):
    ...
    mock = mocker.patch("my_internet_speed.backends.speed_test_net.Speedtest")
